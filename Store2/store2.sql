...
/****** Object:  Database [Store2]    Script Date: 19.05.2023 1:56:26 ******/
CREATE DATABASE [Store2]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'Store2', FILENAME = N'D:\Program Files\MSSQL16.MSSQLSERVER\MSSQL\DATA\Store2.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'Store2_log', FILENAME = N'D:\Program Files\MSSQL16.MSSQLSERVER\MSSQL\DATA\Store2_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
